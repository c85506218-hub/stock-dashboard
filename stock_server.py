...
WATCHLIST = [
    ...
    # ── 台灣 ETF ──────────────────────────────────────────────────
    ("0050.TW",   "元大台灣50",             "台灣ETF",  "NTD"),
    ("0056.TW",   "元大高股息",             "台灣ETF",  "NTD"),
    ("00631L.TW", "元大台灣50正2",          "台灣ETF",  "NTD"),
    ("00635U.TW", "期元大S&P黃金",          "台灣ETF",  "NTD"),
    ("00687B.TW", "國泰20年美債",           "台灣ETF",  "NTD"),
    ("00713.TW",  "元大台灣高息低波",       "台灣ETF",  "NTD"),
    ("00731.TW",  "復華富時高息低波",       "台灣ETF",  "NTD"),
    ("00738U.TW", "期元大道瓊白銀",         "台灣ETF",  "NTD"),
    ("00850.TW",  "元大臺灣ESG永續",        "台灣ETF",  "NTD"),
    ("00878.TW",  "國泰永續高股息",         "台灣ETF",  "NTD"),
    ("00881.TW",  "國泰台灣科技龍頭",       "台灣ETF",  "NTD"),
    ("00900.TW",  "富邦特選高股息30",       "台灣ETF",  "NTD"),
    ("00919.TW",  "群益台灣精選高息",       "台灣ETF",  "NTD"),
    ("00940.TW",  "元大台灣價值高息",       "台灣ETF",  "NTD"),

    # ── 台股個股 ──────────────────────────────────────────────────
    ("1519.TW",  "華城 1519",              "台股個股", "NTD"),
    ("2002.TW",  "中鋼 2002",              "台股個股", "NTD"),
    ("2303.TW",  "聯電 2303",              "台股個股", "NTD"),
    ("2317.TW",  "鴻海 2317",              "台股個股", "NTD"),
    ("2330.TW",  "台積電 2330",            "台股個股", "NTD"),
    ("2344.TW",  "華邦電 2344",            "台股個股", "NTD"),
    ("2409.TW",  "友達 2409",              "台股個股", "NTD"),
    ("2454.TW",  "聯發科 2454",            "台股個股", "NTD"),
    ("2610.TW",  "華航 2610",              "台股個股", "NTD"),
    ("2618.TW",  "長榮航 2618",            "台股個股", "NTD"),
    ("2727.TW",  "王品 2727",              "台股個股", "NTD"),
    ("2883.TW",  "開發金 2883",            "台股個股", "NTD"),
    ("2884.TW",  "玉山金 2884",            "台股個股", "NTD"),
    ("2885.TW",  "元大金 2885",            "台股個股", "NTD"),
    ("2886.TW",  "兆豐金 2886",            "台股個股", "NTD"),
    ("2891.TW",  "中信金 2891",            "台股個股", "NTD"),
    ("3017.TW",  "奇鋐 3017",              "台股個股", "NTD"),
    ("5392.TW",  "能率 5392",              "台股個股", "NTD"),
    ("5519.TW",  "隆大 5519",              "台股個股", "NTD"),
    ("6505.TW",  "台塑化 6505",            "台股個股", "NTD"),
    ("6643.TW",  "M31 6643",               "台股個股", "NTD"),
    ...
    # ── 美股 ETF ──────────────────────────────────────────────────
    ("VOO",     "VOO (Vanguard S&P500)",   "美股ETF",  "USD"),
...
SECTIONS_ORDER = ["台股大盤", "台灣ETF", "台股個股", "美股大盤", "美股ETF", "美股個股"]
